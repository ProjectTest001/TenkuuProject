...
HRESULT	CTitle::Init()
{
	...
	CTitle2d::Create(m_pRenderer->GetDevice(),D3DXVECTOR3(100.0f,10.0f,0.0f),D3DXVECTOR2(600.0f,350.0f),CTitle2d::NONE,TITLE_TEXTURE);
	CTitle2d::Create(m_pRenderer->GetDevice(),D3DXVECTOR3(330.0f,220.0f,0.0f),D3DXVECTOR2(212.0f,362.0f),CTitle2d::NONE,24);

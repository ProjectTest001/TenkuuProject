...
void	CRenderer::SetRenderType(CRenderer::RENDER_TYPE type)
{
	...
	case	SUBTRACTION:
		...
		m_D3DDevice->SetRenderState(D3DRS_BLENDOP,D3DBLENDOP_REVSUBTRACT);
		m_D3DDevice->SetRenderState(D3DRS_SRCBLEND,D3DBLEND_ZERO | D3DBLEND_SRCALPHA);
		m_D3DDevice->SetRenderState(D3DRS_DESTBLEND,D3DBLEND_INVBLENDFACTOR);
